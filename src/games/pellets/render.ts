...
/**
 * Seven fruit, one a maze and the last repeating, drawn to read at a glance
 * at a phone's tile size: a silhouette you know, in its own colour.
 */
function paintFruit(ctx: CanvasRenderingContext2D, kind: FruitKind, cx: number, cy: number, u: number, dark: boolean) {
