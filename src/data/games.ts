...
export const games: Game[] = [
  ...
  },
  {
    ...
    slug: 'putt',
    tags: ['sport'],
    description: 'Seven holes of mini golf: a jump over a lily pond, a bank shot into three pipes, then five long holes, each in a place of its own. Draw the ball back like a slingshot, let go, and find the line.',
    accent: PALETTE.green,
    playable: true,
    inDevelopment: true,
  },
