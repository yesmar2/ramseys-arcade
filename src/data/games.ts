...
export const games: Game[] = [
  ...
  },
  {
    ...
    how: 'Arrow keys or the thumb pads move the cannon, space or the up pad fires, three shots in the air at once. The fleet does not trade pot shots — it gathers a volley, and the ships about to fire light up and drop a warning lane first. Read the lanes, get into a cold one, and spend the quiet between volleys clearing rows. From wave three the lanes lean, so a cold column is not automatically safe. There is no cover: moving is your only defence. Clear a wave for a bonus, clear one without being hit for a bigger one. Any ship reaching the line ends the run whatever your lives say. Three lives.',
    accent: '#e85d75',
    playable: true,
  },
]
