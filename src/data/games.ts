...
export const games: Game[] = [
  ...
  },
  {
    ...
    slug: 'putt',
    tags: ['sport'],
    description: 'Mini golf on long holes through a garden, none of them the usual kind. Pull back, let go, and find the line.',
    how: 'Every hole is longer than the screen: the intro flies it from cup to tee, the view follows the ball, and the map in the corner shows the rest, so plan the route. Before a swing, drag or tap the map, scroll, or hold the up and down arrows to look along the hole; the swing brings the view back. Pull back from the ball and let go to shoot: the further you pull, the harder it goes, and the guide grows with the pull. Pull back to the ball to change your mind. Holes bend and loop, and the rails are wherever the green ends. Sand drags, water costs a stroke and sends you back, and a bridge is the dry way over it. A windmill’s sails shut its doors as they pass, so time the run through the tunnel under it. A ramp flies the ball over whatever is in the way if it is hit hard and straight; soft or crooked, it rolls off the end. Hills push the ball back down unless it is hit firmly, boulders stand where they are, and a ball rolling too fast skips over the cup. The score is golf: par pays 200, a birdie 300, a bogey 100, an ace extra. On a keyboard, arrows aim and holding Space charges the shot; let go to hit.',
    accent: PALETTE.green,
    playable: true,
    inDevelopment: true,
  },
