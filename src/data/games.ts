...
export const games: Game[] = [
  ...
  },
  {
    ...
    slug: 'barrage',
    tags: ['arcade'],
    description: 'Rows of ships. One cannon that grows. Hold the line.',
    how: 'Arrow keys or A and D move the cannon, space fires; on a phone, drag on the field or use the left pads to move, and hold Fire. The fleet fires in volleys: the ships about to shoot light up and their lanes show where the shots will land. Get into a cold lane, or break a lit ship before it fires to stop its shot. Ships glowing orange, amber or blue carry a capsule, one of them at the front of every wave: break it and catch what falls. Each capsule is a level of a power, up to three: Spread fans your rounds out, Pierce drives the middle round through hulls, Rapid fires faster. Powers stay with you from wave to wave, and losing a cannon costs a level of each. Every third shot you stop builds a mirror over the cannon, which sends the next round that would hit you back up its lane. Kills in quick succession build a chain that multiplies your points. There is no cover, and a ship that reaches the line ends the run. Three lives.',
    accent: PALETTE.red,
    playable: true,
  },
  {
