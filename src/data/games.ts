...
export const games: Game[] = [
  ...
  },
  {
    ...
    slug: 'crosswalk',
    tags: ['arcade'],
    description: 'Hop forever. Flowing pays more than crawling.',
    how: 'Swipe or tap to hop, or use the arrow keys. Cross the road, the river and the rails — one mistake ends the run, and so does letting the clock run out without reaching a new row. Rows taken back to back build a chain, and the chain multiplies what every row pays. How far you got is a record of its own.',
