...
const SCORING: Record<string, ScoreRow[]> = {
  ...
  barrage: [
    { label: 'Ships', value: '10–40 by row, the top row most' },
    { label: 'Plated ships', value: '2–3 rounds to break · ×2 / ×3 score' },
    { label: 'Stop a shot', value: 'destroy a lit ship before it fires: +50' },
    { label: 'Chain', value: 'kills within 1.8s of each other · ×2 at 8, ×3 at 16, ×4 at 24' },
    { label: 'The chain pays on', value: 'ships and stopped shots · any hit keeps it alive' },
    { label: 'Shots in the air', value: '4 at once · the lights on the cannon' },
    ...
    { label: 'Supply runner', value: '+150 · shoot it, then catch the capsule it drops' },
    { label: 'Spread · Slow · Pierce · Jam', value: 'fan fire · slow the volley · punch a column · fizzle the next volley' },
    { label: 'Clear a wave', value: '+250 · +500 more if you took no hits' },
