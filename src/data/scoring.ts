...
const SCORING: Record<string, ScoreRow[]> = {
  ...
  crosswalk: [
    ...
    { label: 'The clock', value: 'ten seconds to reach a new row, less later on' },
    { label: 'Letting it run out', value: 'the hawk takes you — hopping in place will not reset it' },
