...
const SCORING: Record<string, ScoreRow[]> = {
  ...
  crosswalk: [
    { label: 'Every new row', value: '+10 × your chain multiplier' },
    { label: 'Chain', value: 'rows taken back to back' },
    { label: 'Chain multiplier', value: '×2 at 10 · ×3 at 20 · ×4 at 30' },
    ...
    { label: 'Squeezing past a car', value: 'buys the chain another beat' },
    { label: 'How far you got', value: 'a record of its own — distance is not the score' },
