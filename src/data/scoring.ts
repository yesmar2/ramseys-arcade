...
const SCORING: Record<string, ScoreRow[]> = {
  ...
  'centroid': [
    ...
    { label: 'The margin', value: '8% of the plate’s size at first, closing to 3%' },
  ...
  findbug: [
    ...
    { label: 'Which bugs', value: '12 — eight beetles, a bee, an ant, a grasshopper and a butterfly' },
    { label: 'What picks it out', value: 'its kind and colours, hat, glasses and what it holds up — only one bug has all four' },
  ...
  fireflies: [
    ...
    { label: 'Each firefly caught in a Catch', value: '+1 · eight light its lantern · three taps on a dark one end it' },
    { label: 'Finding the one you followed', value: '+3' },
    { label: 'All five lanterns lit', value: '+5, one as each rings · then the next night' },
    { label: 'A night', value: 'three tunes, a Catch and a Follow · a lost Catch or Follow plays another round' },
    { label: 'The tune', value: 'three notes to start, a note longer every tune, night after night' },
    { label: 'Newcomers', value: 'a fifth firefly on night 2, a sixth on night 3' },
    { label: 'Trading places', value: 'before tunes from night 2 · a Follow trades more, and quicker, every night' },
    { label: 'Keys', value: '1 to 6 — each firefly’s own number, or at the end of a Follow, the one under it' },
    { label: 'Wrong note in a tune', value: 'the run is over' },
  ],
  frenzy: [
