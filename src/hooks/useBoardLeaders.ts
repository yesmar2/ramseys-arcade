 ...
 * with no scores at all is simply absent. The wall shows it on the tiles
 * where you have no numbers of your own, the way an arcade shows the high
 * score on every cabinet.
 */
